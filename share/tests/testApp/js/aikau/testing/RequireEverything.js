...
define(["dojo/_base/declare",
         ...
         "aikauTesting/ConsoleLog",
         "aikauTesting/CssOverrides",
         ...
         "aikauTesting/mockservices/SearchTestService",
         ...
         "aikauTesting/RequireEverything",
         "alfresco/logging/SubscriptionLog",
         "aikauTesting/TestCoverageResults",
         "aikauTesting/UnitTestService",
         "aikauTesting/WaitForMockXhrService",
