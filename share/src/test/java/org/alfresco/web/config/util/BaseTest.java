...
public abstract class BaseTest extends TestCase
{
    ...
    public BaseTest()
    {
        ...
        // Try to get resources dir from a system property otherwise uses the
        // default
        // hardcoded
        // backward compatible
        String resourcesDir = null;
        // This allows subclasses to override the getResourcesDir method (e.g.
        // by
        // passing classpath: )
        ...
        // Returns the resources dir with trailing separator or just the
        // classpath:
    ...
    /**
     * Override this method to pass a custom resource dir. Valid values are a
     * file system path or the string "classpath:"
     * 
     * @return
     */
     ...
     * resources, please pass the full resource URI, prepended with the
     * classpath: string
     * 
     * @param fullFileName
     */
    protected void assertFileIsValid(String fullFileName)
    {
        ...
        {
            // if we load from classpath, we need to remove the "classpath:"
            // trailing string
     ...
     * 
     * In case of file resource, just provide the file name relative to
     * resourceDir In case of classpath resources, just provide the resource
     * URI, without with the prepending classpath: string
     * 
     * @param xmlConfigFile
     * @return
     */
    ...
    protected XMLConfigService initXMLConfigService(List<String> xmlConfigFilenames)
    {
        ...
        {
            // if we load from classpath then no need to prepend the resources
            // dir (which
