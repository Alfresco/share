 ...
 * 
 * @module cmm/dnd/DroppedNestingItemValueWrapper
 * @extends module:cmm/dnd/DroppedItemValueWrapper
 * @author Dave Draper
 * @author Richard Smith
 */
define(["dojo/_base/declare",
        "cmm/dnd/DroppedItemValueWrapper",
        ...
        "dijit/registry",
        "jquery"], 
        function(declare, DroppedItemValueWrapper, Constants, ObjectTypeUtils, lang, array, on, Deferred, registry, $) {
   
   return declare([DroppedItemValueWrapper], {
       ...
       * @instance
       */
      postCreate: function cmm_dnd_DroppedNestingItemWrapper__postCreate() {
       ...
       */
      allWidgetsProcessed: function cmm_dnd_DroppedNestingItemWrapper__allWidgetsProcessed(widgets) {
         this.inherited(arguments);
       ...
       */
      onItemDelete: function cmm_dnd_DroppedNestingItemWrapper__onItemDelete(/* jshint unused:false */ evt) {
       ...
       */
      onNestedTargetUpdated: function cmm_dnd_DroppedNestingItemWrapper__onNestedTargetUpdated(evt) {
       ...
       * @param {object} evt The drop event.
       */
      onNestedTargetReordered: function cmm_dnd_DroppedNestingItemWrapper__onNestedTargetReordered(evt) {
         if (evt.targetWidget === this)
         {
            // We've managed to catch our own emitted event, allow bubbling to continue...
         }
       ...
       * @instance
       */
      notifyParentOfChange: function cmm_dnd_DroppedNestingItemWrapper__notifyParentOfChange() {
       ...
       */
      onNestedConfig: function cmm_dnd_DroppedNestingItemWrapper__onNestedConfig(resolvedPromise) {
       ...
       * @param {promise} resolvedPromise A resolved promise that is expected to contain a widgets array
       */
      onEditConfig: function cmm_dnd_DroppedNestingItemWrapper__onEditConfig(item, resolvedPromise) {
