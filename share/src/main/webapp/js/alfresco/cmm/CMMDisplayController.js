...
define(["dojo/_base/declare",
        ...
        "cmm/CMMConstants",
        "dojo/io-query"],
        function(declare, AlfCore, AlfXhr, lang, AlfConstants, CMMConstants, ioQuery) {
   ...
   return declare([AlfCore, AlfXhr], {
       ...
       */
      constructor: function alfresco_cmm_services_CMMDisplayService__constructor(args) {
       ...
       */
      showModels: function alfresco_cmm_services_CMMDisplayService__showModelListing() {
       ...
       * @param {object} payload The details of the request
       */
      showTypesAndPropertyGroups: function alfresco_cmm_services_CMMDisplayService__showTypesAndPropertyGroups(payload) {
       ...
       * @param {object} payload The details of the request
       */
      showProperties: function alfresco_cmm_services_CMMDisplayService__showProperties(payload) {
       ...
       * @param {object} payload The details of the request
       */
      showFormEditor: function alfresco_cmm_services_CMMDisplayService__showFormEditor(payload) {
       ...
       */
      _setDisplay: function alfresco_cmm_services_CMMDisplayService___setDisplay(payload) {
