<@markup id="css" >
   <#-- CSS Dependencies -->
   <@link rel="stylesheet" type="text/css" href="${url.context}/res/components/dashlets/my-documents.css" group="dashlets"  />
</@>

<@markup id="js">
   <#-- JavaScript Dependencies -->
   <@script type="text/javascript" src="${url.context}/res/components/dashlets/my-documents.js" group="dashlets"/>
</@>
         ...
         <div class="toolbar flat-button">
            <div class="hidden">
               ...
               <#list filters as filter>
                  <option value="${filter?html}">${msg("filter." + filter)}</option>
               </#list>
               </select>
