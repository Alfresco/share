   ...
   <@link href="${url.context}/res/components/preview/viewer-common.css" group="${dependencyGroup}" />
   <@link href="${url.context}/res/components/preview/PdfJs.css" group="${dependencyGroup}" />
