   ...
   <div class="bd">
      <div id="${el}-logo" class="${aboutConfig.getChildValue("css-class")!logo-com} logo">
         <div class="about">
            ...
            <div>(${shareBuild?html}, Aikau ${shareLibs.aikau?html},  Spring Surf ${shareLibs.surf?html}, Spring WebScripts ${shareLibs.webscripts?html}, Freemarker ${shareLibs.freemarker?html}, Rhino ${shareLibs.rhino?html}, Yui ${shareLibs.yui?html})</div>
