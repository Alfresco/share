            ...
            <div class="byemailbody">  
               <table class="byemailuser">
                  <tr>
                     ...
                     <td class="einput"><input type="text" id="${args.htmlid}-firstname" tabindex="1" /></td>
                  ...
                  <tr>
                     ...
                     <td class="einput"><input type="text" id="${args.htmlid}-lastname" tabindex="2" /></td>
                  </tr>
                  <tr>
                     <td class="elabel"><label for="${args.htmlid}-email">${msg("addemail.email")}:</label></td>
                     <td class="einput"><input type="text" id="${args.htmlid}-email" tabindex="3" /></td>
                  </tr>
               </table>
            </div>
         </div>
