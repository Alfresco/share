 ...
 * @author muzquiano
 */
public class VirtualizedWebappResourceLoader extends AbstractCachingResourceLoader
{
    public VirtualizedWebappResourceLoader(String protocolId, String endpointId, FrameworkBean frameworkUtil)
    {
    ...
    {
        return new VirtualizedWebappResource(getProtocolId(), getEndpointId(), objectId, frameworkUtil);
    }
}
