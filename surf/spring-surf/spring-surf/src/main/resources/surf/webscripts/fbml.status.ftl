...
<table>
 <tr>
    <td><img src="${url.context}/res/images/logo/SurfLogo200.png" alt="Alfresco" /></td>
...
<table>
 ...
 <tr><td><b>Server</b>:<td>${server.edition?html} v${server.version?html} schema ${server.schema?html}
