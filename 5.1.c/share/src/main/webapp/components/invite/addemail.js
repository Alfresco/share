...
(function()
{
    ...
    */
    ...
    {  
      ...
      form.setSubmitElements(this.widgets.addEmailButton);         

      // Form field validation
      form.addValidation(this.id + "-firstname", Alfresco.forms.validation.mandatory, null, "keyup");
      form.addValidation(this.id + "-lastname", Alfresco.forms.validation.mandatory, null, "keyup");
      form.addValidation(this.id + "-email", Alfresco.forms.validation.mandatory, null, "keyup");           
      form.addValidation(this.id + "-email", Alfresco.forms.validation.email, null, "change");
