...
/**
 * Represents a row in the CMM property groups table.
 * 
...
public class ModelPropertyGroupRow
{
    ...
    /**
     * Instantiates a new custom model property group row.
     */
     ...
     */
    public ModelPropertyGroupRow(WebElement nameElement, String displayLabel, String parent, String layout, ActionsSet actions)
    {
        super();
    ...
    public boolean equals(Object obj)
    {
        ...
        if (getClass() != obj.getClass())
            return false;
        ModelPropertyGroupRow other = (ModelPropertyGroupRow) obj;
        if (name == null)
        {
            if (other.name != null)
                return false;
