...
public class CreateNewPropertyGroupPopUp extends ShareDialogueAikau
{
    ...
    private static final By NEW_PROPERTY_GROUP_CREATE_BUTTON = By.cssSelector("span[widgetid='CMM_CREATE_PROPERTYGROUP_DIALOG_OK']");

    private static final By NEW_PROPERTY_GROUP_CANCEL_BUTTON = By.id("CMM_CREATE_PROPERTYGROUP_DIALOG_CANCEL");
