...
/**
 * This class contains the CSS details of the elements that can be highlighted on FacetedSearch page
 *
 * @author CorinaZ
 */
public enum ItemHighlighted
{
        ...
        private ItemHighlighted(String item)
        {
                ItemHighlighedValue = item;
        }

        public String getItem()
        {
                return ItemHighlighedValue;
        }
