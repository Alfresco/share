...
//
//    /**
//     * Util to perform live search for documents and retry waiting for solr indexing :
...
//     */
//    public List<LiveSearchDocumentResult> getLiveSearchDocResultsWithRetry(WebDriver driver, String searchString, Scope searchScope,
//                                                                  LiveSearchDropdown.ResultType resultType,
//                                                                  boolean expectedInResults, int retrySearchCount)
//    {
//        List<LiveSearchDocumentResult> resultsList = new ArrayList<>();
//        boolean resultOk = false;
//
//        LiveSearchResultItem liveSearchItem = new LiveSearchResultItem(resultType, searchString);
//
//        for (int searchCount = 1; searchCount < retrySearchCount; searchCount++)
//        {
//            LiveSearchDropdown liveSearchDropdown = liveSearch(driver, searchString, searchScope);
//            resultOk = checkLiveSearchResults(driver, searchString, searchScope, liveSearchItem, expectedInResults);
//
//            if (resultOk)
//            {
//                if (resultType == LiveSearchDropdown.ResultType.DOCUMENT)
//                {
//                    resultsList = liveSearchDropdown.getSearchDocumentResults();
//                    return resultsList;
//                }
//            }
//            else
...
//
//    /**
//     * Util to perform live search for sites and retry waiting for solr indexing :
//     * Returns list of site results
//     *
//     * @param driver WebDriver
//     * @param searchString String
//     * @param searchScope Scope
...
//     */
//    public List<LiveSearchSiteResult> getLiveSearchSitesResultsWithRetry(WebDriver driver, String searchString, Scope searchScope,
//                                                                           LiveSearchDropdown.ResultType resultType,
//                                                                           boolean expectedInResults, int retrySearchCount)
//    {
//        List<LiveSearchSiteResult> resultsList = new ArrayList<>();
//        boolean resultOk = false;
//
//        LiveSearchResultItem liveSearchItem = new LiveSearchResultItem(resultType, searchString);
//
...
//            if (resultOk)
//            {
//                if (resultType == LiveSearchDropdown.ResultType.SITE)
//                {
//                    resultsList = liveSearchDropdown.getSearchSitesResults();
//                    return resultsList;
//                }
//            }
//            else
...
//     * @param expectedInResults boolean
//     * @param retrySearchCount int
//     * @return List<LiveSearchPeopleResult>
//     */
//    public List<LiveSearchPeopleResult> getLiveSearchPeopleResultsWithRetry(WebDriver driver, String searchString, Scope searchScope,
//                                                                         LiveSearchDropdown.ResultType resultType,
//                                                                         boolean expectedInResults, int retrySearchCount)
//    {
//        List<LiveSearchPeopleResult> resultsList = new ArrayList<>();
//        boolean resultOk = false;
//
//        LiveSearchResultItem liveSearchItem = new LiveSearchResultItem(resultType, searchString);
//
...
//            if (resultOk)
//            {
//                if (resultType == LiveSearchDropdown.ResultType.PEOPLE)
//                {
//                    resultsList = liveSearchDropdown.getSearchPeopleResults();
//                    return resultsList;
//                }
//            }
//            else
